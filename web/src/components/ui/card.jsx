...
function Card({
  ...
  return (
    <div
      data-slot="card"
      className={cn(
        "flex flex-col gap-5 border border-border bg-card py-5 text-card-foreground",
        className
      )}
      {...props} />
  );
...
function CardTitle({
  ...
  return (
    <div
      ...
      className={cn("font-bold tracking-tight uppercase", className)}
      {...props} />
  );
}
...
function CardDescription({
  ...
  return (
    <div
      ...
      className={cn("text-[12px] tracking-[0.05em] text-muted-foreground", className)}
      {...props} />
  );
}
