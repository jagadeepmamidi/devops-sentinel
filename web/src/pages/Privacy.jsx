...
export default function Privacy() {
  return (
    <SiteLayout>
      <article className="page-wrap grid max-w-3xl gap-6 py-12">
        <div>
        ...
        <section>
          <h2 className="text-xl font-semibold tracking-tight">What stays with you</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold tracking-tight">What we process only if you opt in</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold tracking-tight">What we do not collect</h2>
          <p className="mt-3 text-sm leading-7 text-muted-foreground">
