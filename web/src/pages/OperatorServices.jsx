        ...
        <div className="operator-stack">
          <section className="site-card operator-panel">
            ...
            <p className="site-text">
              Paste a bearer token from your authenticated API session to inspect monitored services.
            </p>
            ...
            <form className="operator-token-form" onSubmit={handleSaveToken}>
              ...
              <button className="site-btn secondary" type="button" onClick={() => { saveOperatorToken(''); setTokenInput(''); setServices([]) }}>
                Clear
              </button>
            </form>
            <p className="operator-note site-text">Use the same token you use for authenticated `/api/*` requests.</p>
          ...
          <section className="site-card operator-panel">
            ...
            {!loading && !token ? <p className="operator-empty">Save a token to load services.</p> : null}
                  ...
                  {services.map((service) => (
                    <tr key={service.id}>
                      <td>
                        ...
                        <div><a className="operator-link" href={service.url} target="_blank" rel="noreferrer">{service.url}</a></div>
                      </td>
                      <td>
                        <span className={`operator-status ${service.last_status || 'unknown'}`}>
          ...
          <section className="site-card soft operator-panel">
            ...
            <p className="site-text">
              ...
              <Link className="operator-link" to="/operator/incidents">incidents console</Link>.
            </p>
          </section>
        </div>
      </main>
