...
export default function Landing() {
	...
	const copyCommand = async () => {
		try {
			await navigator.clipboard.writeText("pip install devops-sentinel-next");
			setCopied(true);
		...
		<div className="site-page landing-page">
			...
			<main id="landing-main" className="site-main site-container">
				<section className="landing-hero" aria-labelledby="landing-title">
					<p className="site-label">Open-source SRE operations platform</p>
					<h1 id="landing-title" className="site-title">
						Monitor{" "}
						<span className="landing-diamond" aria-hidden="true">
							◆
						</span>{" "}
						detect &amp; resolve with AI
					</h1>
					<p className="site-text landing-intro">
						Monitor services, preserve incident evidence, and give humans and AI
						agents a safer path from first signal to blameless postmortem.
					</p>
					...
					>
						...
						<code>pip install devops-sentinel-next</code>
						<button
				...
				<section
					className="site-card soft landing-terminal-preview"
				...
				>
					<article className="site-card landing-step-card">
						...
						<p className="site-text">
							Install from PyPI and run the CLI locally.
						</p>
						<code className="site-inline-code">
					...
					<article className="site-card landing-step-card">
						...
						<h2>Sign in</h2>
						<p className="site-text">
							Run login in terminal and complete auth on website.
						</p>
					...
					<article className="site-card landing-step-card">
						...
						<h2>Monitor</h2>
						<p className="site-text">
							Add service URLs and start continuous health checks.
						</p>
						<code className="site-inline-code">
							sentinel monitor &lt;health-url&gt;
						</code>
					</article>
				</section>
			</main>
