...
const DOC_SECTIONS = {
	overview: {
		...
		body: (
			<>
				...
				<p>
					DevOps Sentinel is an AI-assisted SRE tool for CLI-first incident
					response. It helps teams detect, triage, and resolve service issues
				...
				<div className="docs-feature-grid">
					<article className="site-card soft docs-feature-card">
						...
						<p>
							Detect availability and latency anomalies before they escalate.
						</p>
					</article>
					<article className="site-card soft docs-feature-card">
						<h3>Actionable incident context</h3>
						<p>
							Get concise, operator-friendly summaries and next-step guidance.
						</p>
					</article>
					<article className="site-card soft docs-feature-card">
						<h3>CLI-first workflow</h3>
						<p>
							Install, authenticate, and operate from terminal with minimal
							overhead.
						</p>
					</article>
				</div>
	...
	mcp: {
		...
		body: (
			<>
				<h2>Connect an AI operator</h2>
				<p>
					Install the optional MCP extra and run the local stdio server from
					Claude Desktop, Cursor, or another MCP host.
				</p>
				<div className="site-code-block">
					python -m pip install "devops-sentinel-next[mcp]"{"\n"}
					devops-sentinel-mcp
				</div>
				<p>
					Read-only tools cover health checks, incidents, timelines, anomaly
					analysis, and postmortems. Keep remediation behind explicit approval.
				</p>
			</>
		),
	},
			...
			<>
				...
				<div className="docs-command-list">
					...
					<article className="site-card soft docs-command-item">
						<h3>Doctor</h3>
						<p>
							Check network, auth, and dependency health for troubleshooting.
						</p>
	...
	api: {
		...
		body: (
			<>
				...
				<p>
					Use the REST API or the typed{" "}
					<code className="site-inline-code">@devops-sentinel/client</code>{" "}
					package when integrating monitoring into automation pipelines.
				</p>
				<div className="site-code-block">
					curl -H "Authorization: Bearer YOUR_API_KEY" \{"\n"}{" "}
					https://your-sentinel-host.example/api/services
				</div>
		...
		body: (
			<>
				...
				<article className="site-card soft docs-faq-item">
					...
					<p>
						Service health metrics and incident records stay in your configured
						Supabase project; DevOps Sentinel does not collect telemetry. See{" "}
				...
				<article className="site-card soft docs-faq-item">
					...
					<p>
						...
						when browser callback flow is not available.
					</p>
				</article>
			</>
		),
...
export default function Docs() {
	...
	return (
		<div className="site-page docs-page">
			<a className="site-skip-link" href="#docs-main">
				Skip to content
			</a>
			...
			<main className="site-main site-container docs-main-wrap">
				<section className="site-card docs-hero">
					...
					<h1 className="site-title">
						Operator guide for CLI-first incident response
					</h1>
					<p className="site-text">
						Follow a consistent production workflow: install package,
						authenticate once, monitor continuously, and respond faster from
						terminal.
					</p>
				...
				<section className="docs-layout">
					<aside
						className="site-card docs-sidebar"
