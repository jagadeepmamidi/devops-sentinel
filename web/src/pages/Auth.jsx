        ...
        <div className="auth-page">
            <div className="auth-container">
                <div className="auth-header">
                    ...
                    <p>{isSignUp ? 'Start monitoring your services' : 'Sign in to your account'}</p>
                </div>

                <div className="auth-providers">
                    <button className="btn btn-provider" onClick={() => handleProviderAuth('google')}>
                    ...
                    <button className="btn btn-provider" onClick={() => handleProviderAuth('github')}>
